...
public class DonorAdminDonorList extends javax.swing.JPanel {
    ...
    public DonorAdminDonorList(MainFrameForm mainScreen, DB4OUtil dB4OUtil, EcoSystem ecoSystem, DonorBank donbank) {
        initComponents();
 ...
 private void populateTable() {
        ...
        for (Donor d : ecoSystem.getDonordirectory()) {
            System.out.println("populatetable " + d.getUname());
