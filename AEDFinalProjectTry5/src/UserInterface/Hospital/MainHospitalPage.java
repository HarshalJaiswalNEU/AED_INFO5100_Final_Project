...
public class MainHospitalPage extends javax.swing.JPanel {
    ...
    public MainHospitalPage(MainFrameForm mainScreen, EcoSystem ecoSystem, DB4OUtil dB4OUtil) {
        initComponents();
    ...
    private void btnSigninActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSigninActionPerformed
        ...
        if (cmb_Role.getSelectedItem().toString() == "Doctor") {
            ...
            SignUpDoctor doc = new SignUpDoctor(mainScreen, ecoSystem, dB4OUtil);
        ...
        if (cmb_Role.getSelectedItem().toString() == "Nurse") {
            ...
            //            this.invalidate();
            //            this.validate();
            SignUpNurse n = new SignUpNurse(mainScreen, ecoSystem, dB4OUtil);
        ...
        if (cmb_Role.getSelectedItem().toString() == "Patient") {
            ...
            SignUpPatient signpat = new SignUpPatient(mainScreen, ecoSystem, dB4OUtil);
        ...
        if (cmb_Role.getSelectedItem().toString() == "Hospital Admin") {
            ...
            SignUpHospitalAdmin s = new SignUpHospitalAdmin(mainScreen, ecoSystem, dB4OUtil);
