...
public class SignUpPatient extends javax.swing.JPanel {
    ...
    public SignUpPatient(MainFrameForm mainScreen, EcoSystem ecoSystem, DB4OUtil dB4OUtil) {
        initComponents();
    ...
    private void btn_signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_signupActionPerformed
        ...
        System.out.println("ecoeco "+ecoSystem.getHospitaldirectory().getHospitalList().get(0).getNursedirectory().get(0).getName());
